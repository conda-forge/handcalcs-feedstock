...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/handcalcs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14731&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/handcalcs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `handcalcs` can be installed with:

```
conda install handcalcs
```

It is possible to list all of the versions of `handcalcs` available on your platform with:
